...
def download_notebooks_from_repos(token, org_name, download_path, max_downloads=5):
    """
    ...
    def download_notebook_files(repo, path):
        ...
        while contents:  # Continue until the contents list is empty
            ...
            if file_content.type == "dir":
                ...
                contents.extend(repo.get_contents(file_content.path))  # 添加子目录中的内容到待处理列表
...
def download_pipeline_from_repos(token, org_name, download_path, max_downloads=5):
    """
...
#     TOKEN = "Your API tokens"
#     ORG_NAME = "data-community-of-practice"
#     DOWNLOAD_PATH = r'path_to_download_folder'
#     MAX_DOWNLOADS = 5
#     
#     # Download Jupyter Notebooks
#     download_notebooks_from_repos(TOKEN, ORG_NAME, DOWNLOAD_PATH, MAX_DOWNLOADS)
#     
#     # Download Groovy Pipelines
