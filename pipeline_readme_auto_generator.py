...
#     # Provide the directory path for Groovy files and the directory path for README files
#     groovy_directory_path = r'D:\ANU - Master of Computing\Course work\8830 - Computing Internship\Primary Project\test'
#     readme_directory_path = r'D:\ANU - Master of Computing\Course work\8830 - Computing Internship\Primary Project\test2'
